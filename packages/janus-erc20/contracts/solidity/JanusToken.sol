...
//
// JanusToken.sol — Abstract base for JanusERC20 confidential tokens.
//
// NOTE: This is the janus-erc20 package copy of JanusToken.sol. It diverges from
// the janus-token package copy at v0.8.1:
//   - janus-token/JanusToken.sol adds batchClaimVerifier at slot 94 in the base
//     (safe for JanusFlow which has no child slots beyond 93).
//   - This file does NOT add batchClaimVerifier in the base because slot 94 is
//     already occupied by JanusERC20.underlying on deployed proxies. The batch
//     claim verifier for JanusERC20 lives at slot 95 in JanusERC20.sol itself.
//
...
//
// JanusERC20 child adds (starting at slot 94):
//   slot 94    underlying               address  (JanusERC20.sol)
//   slot 95    batchClaimVerifier       address  (JanusERC20.sol, v0.8.1)
//   slot 96..144  __gapERC20[49]       uint256[49]
...
// ---------------------------------------------------------------------------
// JanusToken — abstract base (v0.8.0, janus-erc20 package)
// ---------------------------------------------------------------------------
    ...
    OwnableUpgradeable
{
    ...
    // -----------------------------------------------------------------------
    // Storage — slot-stable layout (slots 0..93)
    //
    //   slot  0  babyJub
